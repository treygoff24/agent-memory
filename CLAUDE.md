...
**Memora-lessons arc (2026-07-10→12, IN FLIGHT):** W0/W1 integrated to main, W2/W3 built, W4 four-lane fusion failed the honest eval bar (0.658 vs legacy-on-same-vectors 0.700) and Trey resolved it as **merge dark + W4b** — an authorized autonomous overnight run testing whether context-aware+selective enrichment flips the verdict. **Next session: execute `docs/plans/2026-07-12-w4b-context-enrichment-regate.md`** (r2, Sol-reviewed, pre-registered decision rule; preflight green). Arc ledger + resume block: `thoughts/memora-build/BUILD-STATE.md`. Still awaiting Trey: B3 backfill mechanism + live-repair go (`docs/reviews/memora-arc/trey-decision-packet-2026-07-12.md`).
