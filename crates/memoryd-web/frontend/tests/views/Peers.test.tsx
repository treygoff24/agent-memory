...
describe('peers view', () => {
    it('peers renders sortable trust ledger, paired badges, pair CTA, and peer-detail inspector', () => {
        render(<Peers />);
        ...
        for (const heading of ['device', 'label', 'trust', 'sync', 'pubkey', 'last handshake', 'locks h/p', 'events 24h']) {
