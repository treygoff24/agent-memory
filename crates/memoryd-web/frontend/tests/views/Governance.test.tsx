...
describe('governance view', () => {
  it('governance renders review filters, batch actions, and governance-decision inspector cards', async () => {
    renderWithProviders(<Governance />);
    await screen.findAllByText('Family detail consent required');
    ...
    expect(screen.getByTestId('governance-view-consent_required')).toHaveTextContent(
      'Family detail consent required',
    );
