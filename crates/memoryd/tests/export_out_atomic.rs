...
fn make_plaintext_memory(id: &str, body: &str, ts_str: &str) -> Memory {
    ...
    Memory {
        frontmatter: Frontmatter {
            ...
            scope: Scope::Agent,
            summary: format!("atomic fixture {id}"),
            confidence: 0.9,
            ...
            author: Author {
                ...
                subagent_id: None,
                phase: None,
                component: Some("export-atomic-test".to_string()),
            },
            namespace: None,
...
async fn out_writes_atomically_and_matches_stdout() {
    ...
    let substrate = init_substrate(&substrate_temp).await;
