# Stream F Dreaming Spec v0.2

**Status:** implementation contract for Stream F dreaming. Supersedes `stream-f-dreaming-v0.1.md`.
**Date:** 2026-04-30.
...
#### 6.3.1 Evidence ref validation rules
