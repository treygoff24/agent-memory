# Stream A — Core Substrate Spec (v1.1)
...
The default active triple in v1.0/v1.1 is locked by §20: `local-gemma / embeddinggemma-300m-qat-Q8_0 / 768`.
...
1. Parses every `### Acceptance signals` and `### N.M Acceptance signals` subsection of this spec from `docs/specs/stream-a-core-substrate-v1.1.md`.
...
The following decisions are locked for v1.1. Later streams may add adapters or policy layers without changing the Stream A substrate contract.
