# Stream E Passive Recall Spec v0.3

**Status:** final implementation contract for Stream E passive recall. Supersedes `stream-e-passive-recall-v0.2.md`.
**Date:** 2026-04-30.
...
1. Remove stale v0.1/v0.2 labels from normative examples and deferrals; all current policy/version strings are `stream-e-v0.3`.
...
```xml
<memory-recall version="stream-e-v0.3" harness="codex" session="sess_abc123">
  <identity>
  </identity>
  ...
  <recall-explanation policy="stream-e-v0.3" budget-tokens="3600" used-tokens="1420">
  </recall-explanation>
</memory-recall>
```
