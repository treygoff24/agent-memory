# Stream E Passive Recall Spec v0.5

**Status:** final implementation contract for Stream E passive recall. Supersedes `stream-e-passive-recall-v0.4.md`.
**Date:** 2026-04-30.
...
<memory-recall version="stream-e-v0.5" harness="codex" session="sess_abc123">
  ...
  <recall-explanation policy="stream-e-v0.5" budget-tokens="3600" used-tokens="1420">
  </recall-explanation>
</memory-recall>
```
